...
import createFetch from '../server/createFetch'
...
let router = require('../server/router').default
...
if (module.hot) {
    module.hot.accept('../server/router', async () => {
        router = require('../server/router').default
