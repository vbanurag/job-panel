...
const app = process.env.APP || JSON.stringify('dev')
...
const config = {
  ...
  module: {
    rules: [
      ...
      {
        exclude: [
          path.resolve(__dirname, '../src/server/data/Utils/ValidationError.js')
        ]
      },
...
const clientConfig = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env.NODE_ENV': isDebug ? '"staging"' : '"production"',
      'process.env.AUTH_SERVER_URL': isDebug ? '"http://localhost:3001"' : null,
    ...
    // http://webpack.github.io/docs/list-of-plugins.html#commonschunkplugiFFn
